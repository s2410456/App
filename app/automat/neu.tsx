        ...
        <View style={{ flex: 1, backgroundColor: colors.bg }}>
            ...
            <ScrollView contentContainerStyle={{ padding: space(5), gap: space(4) }}>
                ...
                <Feld label="Foto">
                    ...
                    <Pressable style={styles.fotoBtn} onPress={fotoAuswaehlen}>
                        <Ionicons name="image-outline" size={18} color={colors.accent} />
                        <Text style={styles.fotoBtnText}>Foto hinzufügen</Text>
                    </Pressable>
                </Feld>
                ...
                <Feld label="Foto">
                    ...
                    <View style={{ flexDirection: "row", gap: space(2) }}>
                        <Pressable style={styles.fotoBtn} onPress={fotoAufnehmen}>
                        ...
                        <Pressable style={styles.fotoBtn} onPress={fotoAuswaehlen}>
                            <Ionicons name="image-outline" size={18} color={colors.accent} />
                            <Text style={styles.fotoBtnText}>Galerie</Text>
                        </Pressable>
                    </View>
                </Feld>
